...
frappe.ui.form.on("Purchase Receipt Item", {
    ...
    item_code(frm, cdt, cdn) {
        set_secondary_fields_pr(frm, cdt, cdn);
    },

    qty(frm, cdt, cdn) {
        update_from_primary_pr(frm, cdt, cdn);
    },
    ...
    secondary_qty(frm, cdt, cdn) {
        update_from_secondary_pr(frm, cdt, cdn);
    },

    secondary_conversion_factor(frm, cdt, cdn) {
        if (updating) return;
        update_on_factor_change_pr(frm, cdt, cdn);
    }
});


function set_secondary_fields_pr(frm, cdt, cdn) {
...
function update_from_primary_pr(frm, cdt, cdn) {
    if (updating) return;
    updating = true;
...
function update_from_secondary_pr(frm, cdt, cdn) {
    if (updating) return;
    updating = true;
...
function update_on_factor_change_pr(frm, cdt, cdn) {
    if (updating) return;
    updating = true;
